...
docker_deploy:
	PLATFORM=linux/amd64 docker-compose build --push

	scp -i ~/.ssh/fastapi_key.pem docker-compose.yml ubuntu@ec2-3-121-186-17.eu-central-1.compute.amazonaws.com:docker-compose.yml
...
docker_up:
	...
	PLATFORM=linux/arm64 docker compose up --remove-orphans --force-recreate --build
